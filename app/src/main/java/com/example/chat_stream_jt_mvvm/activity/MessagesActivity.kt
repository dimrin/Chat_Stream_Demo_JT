    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            ChatTheme (shapes = StreamShapes.defaultShapes().copy(
                avatar = RoundedCornerShape(8.dp), attachment = RoundedCornerShape(16.dp), myMessageBubble = RoundedCornerShape(16.dp), otherMessageBubble = RoundedCornerShape(16.dp), inputField = RectangleShape
            )) {
//                MessagesScreen(
//                    channelId = channelId,
//                    messageLimit = 30,
