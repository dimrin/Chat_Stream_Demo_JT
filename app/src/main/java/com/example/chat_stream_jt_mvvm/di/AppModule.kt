package com.example.chat_stream_jt_mvvm.di
...
object AppModule {
    ...
    ) = ChatClient.Builder(apiKey = context.getString(R.string.api_key), context)
        .withPlugin(offlinePluginFactory).logLevel(ChatLogLevel.ALL).build()
}